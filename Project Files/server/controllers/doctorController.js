...
const selectedDate = moment(req.body.time); // full ISO
const dateStr = selectedDate.format("YYYY-MM-DD");

const doctorFromTime = moment(`${dateStr}T${doctor.fromTime}`);
const doctorToTime = moment(`${dateStr}T${doctor.toTime}`);

const displayFromTime = doctorFromTime.format("hh:mm A");
const displayToTime = doctorToTime.format("hh:mm A");

if (selectedDate.isBefore(doctorFromTime) || selectedDate.isAfter(doctorToTime)) {
  return next(
    new AppError(
